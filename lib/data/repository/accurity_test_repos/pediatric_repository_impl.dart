    ...
    for (int i = 0; i < nosOfItems; i++) {
      ...
      itemImageList.add(Container(
          ...
          child: Align(
            ...
            child: svgImage(AppConstants.pediatricList[
                random.nextInt(AppConstants.pediatricList.length)]),
          )));
    }
